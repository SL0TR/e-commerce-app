...
})([".bar{box-shadow:0px 1px 3px 2px rgba(0,0,0,.3);display:grid;grid-template-columns:auto 1fr;justify-content:space-between;align-items:stretch;img{height:10rem;width:10rem;}@media (max-width:1300px){grid-template-columns:1fr;justify-content:center;}.sub-bar{display:grid;border-bottom:10px solid ", ";grid-template-columns:1fr auto;}}"], function (props) {
...
//# sourceMappingURL=_app.js.3b56b05752e1d625d0b4.hot-update.js.map