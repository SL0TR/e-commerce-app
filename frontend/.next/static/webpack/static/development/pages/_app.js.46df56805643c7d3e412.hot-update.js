...
})([".bar{box-shadow:0px 1px 3px 2px rgba(0,0,0,.1);display:grid;grid-template-columns:auto 1fr;justify-content:space-between;align-items:stretch;.nav-logo{height:5rem;width:5rem;padding:1rem;border:1px solid ", " &:hover{transition:transform .3s;cursor:pointer;transform:scale(1.03);}}@media (max-width:1300px){grid-template-columns:1fr;justify-content:center;}.sub-bar{display:grid;border-bottom:10px solid ", ";grid-template-columns:1fr auto;}}"], function (props) {
  return props.theme.primary;
}, function (props) {
...
//# sourceMappingURL=_app.js.46df56805643c7d3e412.hot-update.js.map