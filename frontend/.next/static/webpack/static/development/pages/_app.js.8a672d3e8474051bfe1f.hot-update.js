...
})([".bar{box-shadow:0px 1px 3px 2px rgba(0,0,0,.1);display:grid;grid-template-columns:auto 1fr;justify-content:space-between;align-items:stretch;.nav-logo{height:5.5rem;width:5.5rem;border-radius:50%;padding:.3rem;border:1px solid ", ";&:hover{transition:transform .3s;cursor:pointer;transform:scale(1.03);}}@media (max-width:1300px){grid-template-columns:1fr;justify-content:center;}.sub-bar{display:grid;border-bottom:10px solid ", ";grid-template-columns:1fr auto;}}"], function (props) {
  return props.theme.primary;
}, function (props) {
...
//# sourceMappingURL=_app.js.8a672d3e8474051bfe1f.hot-update.js.map