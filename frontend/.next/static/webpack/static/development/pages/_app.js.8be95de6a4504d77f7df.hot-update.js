...
})([".bar{box-shadow:0px 1px 3px 2px rgba(0,0,0,.1);display:grid;grid-template-columns:auto 1fr;justify-content:space-between;align-items:stretch;.nav-logo{height:5rem;width:5rem;}@media (max-width:1300px){grid-template-columns:1fr;justify-content:center;}.sub-bar{display:grid;border-bottom:10px solid ", ";grid-template-columns:1fr auto;}}"], function (props) {
...
//# sourceMappingURL=_app.js.8be95de6a4504d77f7df.hot-update.js.map